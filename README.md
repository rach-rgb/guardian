...
Conda 또는 pip를 사용하여 Python 환경을 설정하는 방법입니다:
...
_Push 완료 후, GitHub 저장소 페이지에서 Pull Request(PR)를 생성하세요._
...
3. **서버 시작**:
   ...
   ```
   _API 서버 주소: http://localhost:8000_
